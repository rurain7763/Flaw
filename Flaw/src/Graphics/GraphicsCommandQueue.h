...
namespace flaw {
	...
	public:
		...
		virtual void SetTexture(const Ref<Texture2DArray>& texture, uint32_t slot) = 0;
		virtual void SetTexture(const Ref<TextureCube>& texture, uint32_t slot) = 0;
		...
		virtual void SetComputeTexture(const Ref<Texture2DArray>& texture, BindFlag bindFlag, uint32_t slot) = 0;
		virtual void SetComputeTexture(const Ref<TextureCube>& texture, BindFlag bindFlag, uint32_t slot) = 0;
